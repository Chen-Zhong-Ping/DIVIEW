...
class MeshListPanel(TreeView):
    ...
    def add_mesh(self, mesh_name):
        ...
        self.add_node(MeshInfoNodeNode(mesh_info = mesh_info), parent = self.add_node(MeshBranchNode(mesh_name = mesh_name)))
...
class BackendDataTracker:
    ...
    def add_geometry_data(self, data_name, data_unit, data_file):
        ...
        self.data_tree[self.current_mesh][data_name]["data2D"] = Data2D(mesh_obj = self.data_tree[self.current_mesh]["mesh"], data2D_file = data_file)
    ...
    def add_simulation_data(self, data_name, data_unit, data_file):
        ...
        self.data_tree[self.current_mesh][self.current_case][data_name]["data2D"] = Data2D(mesh_obj = self.data_tree[self.current_mesh]["mesh"], data2D_file = data_file)
