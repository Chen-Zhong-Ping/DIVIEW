...
class DataScreen(Screen):
    meshlist_panel = ObjectProperty(None)
...
####### I.1.1.2 mesh list panel: panel for a list of mesh
...
######## end of I.1.1 mesh column ##################################
####################################################################
####################################################################

####################################################################
####################################################################
######## I.1.2 data column: panel for a list of cases/data #########

####################################################################
####### I.1.2.2 case spinner: simulation case name spinner #########
...
####################################################################
#### I.1.2.4 datalist panel: a list of data pertaining to each simulation case ####
...
######## end of I.1.3 calculator column ############################
####################################################################
####################################################################

######### end of I.1 data screen ###################################
####################################################################
####################################################################
####################################################################
...
####################################################################
######## I.2.1 various dialogs for the top row buttons #############
...
class AddSubplotDialog(BoxLayout):    # add an axes to the figure, add an recycleview item to the AxesListSubPanel.
    load = ObjectProperty(None)
    cancel = ObjectProperty(None)
    message = ObjectProperty(None)
...
####### end of I.2.2.2.1 fig/axes panel ############################
####################################################################
...
####### end of I.2.2.2.2 colorbar panel ############################
####################################################################
...
####### end of I.2.2.2.3 fig display panel #########################
####################################################################

######## end of I.2.2.2 plot desk ##################################
####################################################################
####################################################################

######### end of I.1 plot screen ###################################
####################################################################
####################################################################
####################################################################
...
class BackendPlotTracker:
    ...
    def add_plot(self, plot_type):
        ...
        # at little tool to ensure adding new axes
        self.plots[self.count]["subplot_count"] = 0
    ...
    def add_subplot(self, axes_name, mesh_name, case_name, data_name):
        ...
        if plot_type is "2d_quad":
            ...
            self.plots[self.current_plot]["AxesList"][-1]["stainedglass"] = StainedGlass2DQuad(self.plots[self.current_plot]["Figure"].add_axes((0.05 * self.plots[self.current_plot]["subplot_count"], 0.05, 0.8, 1)))
        else:
            pass

        # use this to make sure when adding every axes the input is different such that matplotlib does indeed add rather than reuse
        self.plots[self.current_plot]["subplot_count"] += 1
